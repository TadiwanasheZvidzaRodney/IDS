...
if(isset($_POST['signup_submit'])){
	...
	if(strlen($mobile) < 10 || strlen($mobile) > 15) {
		$error = true;
		$mobile_error = "Contact number must be between 10-15 digits";
	} else if(!preg_match("/^[0-9\-\(\)\s]+$/", $mobile)) {
		$error = true;
		$mobile_error = "Please enter a valid contact number";
	}
            ...
            <div class="outer-div">
                ...
                <div class="col-md-7 col-sm-7 form-div">
                    <div class="sec2 sec2-signup">
                        <div class="div1">
                            <div class="link">
                                <h2>Join IDS & Get Nutritional Food!</h2>
                            </div>
                        </div>
                        <div class="div2">
