...
if(isset($_POST['fp-submit'])){
	...
	$query = "select user_email from ids_users where user_email='$email'";
		...
		if($result ==0){
			...
			if(!$run){
				...
				$subject = "Reset password - Intelligent Dietician System"; // Your subject
				$header = "From: IDS care@ids.com"; // From
		        $message = " 
Please click this link to reset your account password:\r\n";
				$message .= "www.ids.com/reset-password.php?token=$token"; //cofirmation link....
...
<html>
<head>
	<title>Forgot password - IDS</title>
