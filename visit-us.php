        ...
        <div class="n-v-content">
            ...
            <div class="col-md-5 col-sm-5 g-loc">
                <div class="loc">
                    ...
                    <h2 class="h2-heading">Intelligent Dietician System<br> Welcomes You at</h2>
                    <hr style="border-top:2px solid #57b63a;width:25%;" align="left"/>
                    <p class="address ape"><img src="images/loc.png"/>Crowborough, Harare, Zimbabwe</p>
                    <p class="email ape"><img src="images/em.png" /> care@ids.com</p>
                    <p class="phone ape"><img src="images/ca.png"/>+263 78 951 8328</p>
                    <p class="s-link">
                </div>
            </div>
...
<script>
function initMap() {
        var harare = {lat: -17.8216, lng: 31.0492}; // Coordinates for Harare, Zimbabwe
